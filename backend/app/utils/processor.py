...
class URLProcessor:
    ...
    async def _process_url(self, url: str) -> URLProcessingResult:
        ...
        try:
            ...
            print(ex)
            return URLProcessingFailure(url=url)

    async def process_urls(self, urls: List[URL]) -> List[URLProcessingResult]:
